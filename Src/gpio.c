...
void MX_GPIO_Init(void)
{
  ...
  GPIO_InitStruct.Pin = DWN_Pin|RHT_Pin|UP_Pin|MID_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = LFT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(LFT_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : PBPin PBPin PBPin PBPin
                           PBPin */
  GPIO_InitStruct.Pin = TFT_SCL_Pin|TFT_SDA_Pin|TFT_DC_Pin|TFT_CS_Pin
                          |TFT_BLK_Pin;
